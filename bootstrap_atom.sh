...
packages=("verse-of-the-day" "godsdjs"
	...
	"pigments" "file-icons" "editorconfig" "clipboard-ide" "clipboard-plus" "undo-tree" "git-time-metric" "npm-plus" "atom-vim-like-tab" 	"bookmarks" "atom-commander" "block-cursor" "atom-cursor-indent" "multi-cursor-plus" "cursor-history" "split-selection-into-cursors" "indent-guide-improved" "line-count-status" "highlight-line"
